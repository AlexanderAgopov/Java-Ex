...
public class PVCWindow extends PVC {
	...
	public PVCWindow(double width, double height, double sqCmGlass, double lCmFrame, double wing1Width,
			double wing1Height, double wing2Width, double wing2Height, double wing3Width, double wing3Height,
			double wing4Width, double wing4Height, double windowGlassPrice, double windowFramePrice,
			double windowPrice) {
		super();
		this.width = width;
		this.height = height;
